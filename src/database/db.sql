...
-- -----------------------------------------------------
-- Table `gestaodb`.`perfis_acesso`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `gestaodb`.`perfis_acesso` (
...
CREATE TABLE IF NOT EXISTS `gestaodb`.`usuarios` (
  ...
  INDEX `fk_usuarios_perfis_acesso1_idx` (`id_perfil_acesso` ASC) VISIBLE,
  CONSTRAINT `fk_usuarios_perfis_acesso1`
    FOREIGN KEY (`id_perfil_acesso`)
    REFERENCES `gestaodb`.`perfis_acesso` (`id_perfil_acesso`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `gestaodb`.`acessos_perfis`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `gestaodb`.`acessos_perfis` (
  `id_acesso` INT NOT NULL,
  `id_perfil_acesso` INT NOT NULL,
  PRIMARY KEY (`id_acesso`, `id_perfil_acesso`),
  INDEX `fk_acessos_usuarios_perfis_acesso1_idx` (`id_perfil_acesso` ASC) VISIBLE,
  CONSTRAINT `fk_acessos_usuarios_acessos1`
    FOREIGN KEY (`id_acesso`)
    REFERENCES `gestaodb`.`acessos` (`id_acesso`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_acessos_usuarios_perfis_acesso1`
    FOREIGN KEY (`id_perfil_acesso`)
    REFERENCES `gestaodb`.`perfis_acesso` (`id_perfil_acesso`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
